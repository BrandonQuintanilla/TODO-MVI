...
public class TaskDetailPresenterTest {
  ...
  @Test public void createPresenter_setsThePresenterToView() {
    ...
    mTaskDetailPresenter =
        new TaskDetailPresenter(ACTIVE_TASK.getId(), mTasksRepository, mTaskDetailView,
            mSchedulerProvider);
  ...
  @Test public void getActiveTaskFromRepositoryAndLoadIntoView() {
  ...
  @Test public void getCompletedTaskFromRepositoryAndLoadIntoView() {
    mTaskDetailPresenter =
        new TaskDetailPresenter(COMPLETED_TASK.getId(), mTasksRepository, mTaskDetailView,
            mSchedulerProvider);
  ...
  @Test public void getUnknownTaskFromRepositoryAndLoadIntoView() {
    ...
    mTaskDetailPresenter =
        new TaskDetailPresenter(INVALID_TASK_ID, mTasksRepository, mTaskDetailView,
            mSchedulerProvider);
    mTaskDetailPresenter.subscribe();
  ...
  @Test public void activeTaskIsShownWhenEditing() {
  ...
  @Test public void invalidTaskIsNotShownWhenEditing() {
  ...
  private void setTaskAvailable(Task task) {
    when(mTasksRepository.getTask(eq(task.getId()))).thenReturn(Single.just(task));
  }
}
