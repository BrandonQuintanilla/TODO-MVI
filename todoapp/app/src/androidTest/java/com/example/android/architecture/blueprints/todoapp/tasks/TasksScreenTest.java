 ...
 */
@RunWith(AndroidJUnit4.class) @LargeTest public class TasksScreenTest {
   ...
   */
  @Rule public ActivityTestRule<TasksActivity> mTasksActivityTestRule =
  ...
  private Matcher<View> withItemText(final String itemText) {
    ...
    return new TypeSafeMatcher<View>() {
      @Override public boolean matchesSafely(View item) {
  ...
  @Test public void clickAddTaskButton_opensAddTaskUi() {
  ...
  @Test public void editTask() throws Exception {
    // First add a task
    ...
    onView(withId(R.id.add_task_title)).perform(replaceText(editTaskTitle),
  ...
  @Test public void addTaskToTasksList() throws Exception {
    createTask(TITLE1, DESCRIPTION);
  ...
  @Test public void markTaskAsComplete() {
    viewAllTasks();
  ...
  @Test public void markTaskAsActive() {
    viewAllTasks();
  ...
  @Test public void showActiveTasks() {
    // Add 2 active tasks
    createTask(TITLE1, DESCRIPTION);
    createTask(TITLE2, DESCRIPTION);
  ...
  @Test public void showCompletedTasks() {
  ...
  @Test public void clearCompletedTasks() {
    viewAllTasks();
  ...
  @Test public void createOneTask_deleteTask() {
    viewAllTasks();
  ...
  @Test public void createTwoTasks_deleteOneTask() {
    // Add 2 active tasks
    createTask(TITLE1, DESCRIPTION);
    createTask(TITLE2, DESCRIPTION);
  ...
  @Test public void markTaskAsCompleteOnDetailScreen_taskIsCompleteInList() {
    viewAllTasks();
  ...
  @Test public void markTaskAsActiveOnDetailScreen_taskIsActiveInList() {
    viewAllTasks();
    ...
    onView(allOf(withId(R.id.complete), hasSibling(withText(TITLE1)))).check(
        matches(not(isChecked())));
  }

  @Test public void markTaskAsAcompleteAndActiveOnDetailScreen_taskIsActiveInList() {
    viewAllTasks();
  ...
  @Test public void markTaskAsActiveAndCompleteOnDetailScreen_taskIsCompleteInList() {
    viewAllTasks();
  ...
  @Test public void orientationChange_FilterActivePersists() {
  ...
  @Test public void orientationChange_FilterCompletedPersists() {
  ...
  @Test @SdkSuppress(minSdkVersion = 21) // Blinking cursor after rotation breaks this in API 19
  public void orientationChange_DuringEdit_ChangePersists() throws Throwable {
    ...
    onView(withId(R.id.add_task_title)).perform(replaceText(TITLE2),
        closeSoftKeyboard()); // Type new task title
  ...
  private String getToolbarNavigationContentDescription() {
    return TestUtils.getToolbarNavigationContentDescription(mTasksActivityTestRule.getActivity(),
        R.id.toolbar);
  }
}
