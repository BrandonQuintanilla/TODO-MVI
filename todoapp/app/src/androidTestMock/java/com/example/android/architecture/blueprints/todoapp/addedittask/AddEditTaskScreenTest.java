 ...
 */
@RunWith(AndroidJUnit4.class) @LargeTest public class AddEditTaskScreenTest {
   ...
   */
  @Rule public IntentsTestRule<AddEditTaskActivity> mAddTaskIntentsTestRule =
  ...
  @Test public void emptyTask_isNotSaved() {
