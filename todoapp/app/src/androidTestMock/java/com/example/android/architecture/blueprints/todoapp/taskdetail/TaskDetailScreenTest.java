 ...
 */
@RunWith(AndroidJUnit4.class) @LargeTest public class TaskDetailScreenTest {
   ...
   */
  @Rule public ActivityTestRule<TaskDetailActivity> mTaskDetailActivityTestRule =
      new ActivityTestRule<>(TaskDetailActivity.class, true /* Initial touch mode  */, false /* Lazily launch activity */);
  ...
  @Test public void activeTaskDetails_DisplayedInUi() throws Exception {
    loadActiveTask();
  ...
  @Test public void completedTaskDetails_DisplayedInUi() throws Exception {
    loadCompletedTask();
  ...
  @Test public void orientationChange_menuAndTaskPersist() {
    loadActiveTask();
