...
interface TasksResult extends MviResult {
  @AutoValue abstract class LoadTasks implements TasksResult {
    @NonNull abstract LceStatus status();
  ...
  @AutoValue abstract class GetLastState implements TasksResult {
    static GetLastState create() {
      return new AutoValue_TasksResult_GetLastState();
    }
  }

  @AutoValue abstract class ActivateTaskResult implements TasksResult {
    @NonNull abstract LceStatus status();
    ...
    @NonNull static ActivateTaskResult success(@NonNull List<Task> tasks) {
      return new AutoValue_TasksResult_ActivateTaskResult(SUCCESS, tasks, null);
    }

    @NonNull static ActivateTaskResult failure(Throwable error) {
      return new AutoValue_TasksResult_ActivateTaskResult(FAILURE, null, error);
    }

    @NonNull static ActivateTaskResult inFlight() {
      return new AutoValue_TasksResult_ActivateTaskResult(IN_FLIGHT, null, null);
    }
  }

  @AutoValue abstract class CompleteTaskResult implements TasksResult {
    @NonNull abstract LceStatus status();
    ...
    @NonNull static CompleteTaskResult success(@NonNull List<Task> tasks) {
      return new AutoValue_TasksResult_CompleteTaskResult(SUCCESS, tasks, null);
    }

    @NonNull static CompleteTaskResult failure(Throwable error) {
      return new AutoValue_TasksResult_CompleteTaskResult(FAILURE, null, error);
    }

    @NonNull static CompleteTaskResult inFlight() {
      return new AutoValue_TasksResult_CompleteTaskResult(IN_FLIGHT, null, null);
    }
  }

  @AutoValue abstract class ClearCompletedTasksResult implements TasksResult {
    @NonNull abstract LceStatus status();
    ...
    @NonNull static ClearCompletedTasksResult success(@NonNull List<Task> tasks) {
      return new AutoValue_TasksResult_ClearCompletedTasksResult(SUCCESS, tasks, null);
    }

    @NonNull static ClearCompletedTasksResult failure(Throwable error) {
      return new AutoValue_TasksResult_ClearCompletedTasksResult(FAILURE, null, error);
    }

    @NonNull static ClearCompletedTasksResult inFlight() {
