...
class StatisticsScreenTest {
  ...
  fun Tasks_ShowsNonEmptyMessage() {
    ...
    val expectedActiveTaskText = InstrumentationRegistry.getTargetContext().getString(
        R.string.statistics_active_tasks)
    onView(withText(containsString(expectedActiveTaskText))).check(matches(isDisplayed()))

    val expectedCompletedTaskText = InstrumentationRegistry.getTargetContext().getString(
